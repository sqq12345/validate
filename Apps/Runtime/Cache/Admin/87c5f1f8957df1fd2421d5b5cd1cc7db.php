...
<table id='tab' class="easyui-datagrid"  data-options="url:'<?php echo U('group/getdb');?>',fitColumns:true,singleSelect:true,toolbar: '#tool'
">
    <thead>
        <tr>
            ...
            <th data-options="field:'title',width:100">角色名称</th>                
            <th data-options="field:'level',width:100">动作权限</th>
 ...
 $('#delbtn').linkbutton({
     onClick: function () {
         ...
         if (currow != null) {
     		...
     		function(index){
         		var url = "/index.php/Admin/Group/del/id/" + currow.id;
 ...
 //修改按钮
  $('#editbtn').linkbutton({
     onClick: function () {
         var currow = $('#tab').datagrid("getSelected");
         if (currow != null) {
         	var url = "/index.php/Admin/Group/edit/id/" + currow.id;
         	showWin(url,'修改');
         } else {
             $.messager.alert('错了', "请先选中一行！", 'warning');
         }
