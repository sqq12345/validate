...
<table id='tab' class="easyui-datagrid"  data-options="url:'<?php echo U('level/getdb');?>',pagination:true,fitColumns:true,singleSelect:true,toolbar: '#tool'">
    <thead>
        <tr>
 ...
 $('#delbtn').linkbutton({
     onClick: function () {
         ...
         if (currow != null) {
     		...
     		function(index){
         		var url = "/index.php/Admin/Level/del/id/" + currow.id;
 ...
 //修改按钮
  $('#editbtn').linkbutton({
     onClick: function () {
         var currow = $('#tab').datagrid("getSelected");
         if (currow != null) {
         	var url = "/index.php/Admin/Level/edit/id/" + currow.id;
         	showWin(url);
         } else {
             $.messager.alert('错了', "请先选中一行！", 'warning');
         }
