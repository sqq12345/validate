...
<div id="win" class="easyui-window" data-options="iconCls:'icon-add',modal:true,closed:true,title:'操作',collapsible:false,minimizable:false,
    ...
    <table id='tab' class="easyui-datagrid"  data-options="url:'<?php echo U('menu/getdb');?>',fitColumns:true,singleSelect:true,toolbar: '#tool'
">
        <thead>
            <tr>
                ...
                <th data-options="field:'hidden',width:100">隐藏</th>                
    ...
    <div id="tool">
        <a href="javascript:;" id="addbtn" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" >添加</a>
        <a href="javascript:;"  id="editbtn" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" >修改</a>
        <a href="javascript:;" id="delbtn" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',plain:true">删除</a>
    </div>
 ...
 $('#delbtn').linkbutton({
     onClick: function () {
         ...
         if (currow != null) {
     		...
     		function(index){
         		var url = "/index.php/Admin/Menu/del/id/" + currow.id;
